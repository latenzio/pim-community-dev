...
class TurnProductIntoVariantProductIntegration extends TestCase
{
    ...
    public function test that the variant product have the same parent than the product()
    {
    ...
    public function test that the variant product have the same groups than the product()
    {
        /** @var VariantProductInterface $variantProduct */
        $variantProduct = $this->get('pim_catalog.entity_with_family.turn_product_into_variant_product')
            ->turnInto($this->product, $this->productModel);
    ...
    public function test that the variant product have the same completeness than the product()
    {
        /** @var VariantProductInterface $variantProduct */
        $variantProduct = $this->get('pim_catalog.entity_with_family.turn_product_into_variant_product')
            ->turnInto($this->product, $this->productModel);
    ...
    public function test that the variant product have the same association than the product()
    {
        /** @var VariantProductInterface $variantProduct */
        $variantProduct = $this->get('pim_catalog.entity_with_family.turn_product_into_variant_product')
            ->turnInto($this->product, $this->productModel);
    ...
    public function test that the variant product have the same categories than the product()
    {
        /** @var VariantProductInterface $variantProduct */
        $variantProduct = $this->get('pim_catalog.entity_with_family.turn_product_into_variant_product')
            ->turnInto($this->product, $this->productModel);
